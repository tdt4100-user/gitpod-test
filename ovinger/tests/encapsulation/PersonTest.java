...
public class PersonTest {
    ...
    private void testExceptionAndValue(Exception e, Class<? extends Exception> c, Object expected, Object actual) {
        _assertTrue(e + " should be assignable to " + c, c.isAssignableFrom(e.getClass()));
    ...
    public void testSetName() {
        ...
        try {
            ...
            _assertEquals("Espen Askeladd", person.getName());
        } catch (Exception e) {
    ...
    public void testSetBirthday() {
        ...
        try {
            ...
            _assertEquals(thePast, person.getBirthday());
        } catch (Exception e) {
    ...
    public void testSetEmail() {
        ...
        try {
            ...
            _assertEquals("ola.nordmann@ntnu.no", person.getEmail());
        } catch (Exception e) {
    ...
    public void testExtraCountryTopLevelDomains() {
        ...
        for (String cTLD : cTLDs) {
            ...
            try {
                ...
                _assertEquals(email, person.getEmail());
            } catch (Exception e) {
